...
public class Settings extends Fragment {
    ...
    // getting buttons from fragment_settings.xml
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // initializing buttons from settings_fragment.xml
        selectLocation = view.findViewById(R.id.selectLocation);
        selectLanguage = view.findViewById(R.id.selectLanguage);
        about = view.findViewById(R.id.about);

        // functions directing buttons to its layout
        selectLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), SelectProvincePakistan.class);
