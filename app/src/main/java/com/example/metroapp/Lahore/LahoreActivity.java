...
import com.example.metroapp.Islamabad.IslamabadSearch;
import com.example.metroapp.R;
import com.example.metroapp.CommonActivities.Settings;
import com.google.android.material.bottomnavigation.BottomNavigationView;

public class LahoreActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    LahoreMap lahoreMapFragment = new LahoreMap();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.map:
                getSupportFragmentManager().beginTransaction().replace(R.id.container, lahoreMapFragment).commit();
            ...
            case R.id.search:
                ...
                setTitle("IslamabadSearch"); //setting action bar title
                return true;
            case R.id.nearby:
